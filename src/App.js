...
class App extends Component {
  ...
  login() {
    ...
    email === "zineb" && password === "zineb" ? this.setState({
      user:{
        email : email,
        password : password    
      }
  ...
  renderHeader(){
    return(
      <header className="App-header">
        <img src='https://1.bp.blogspot.com/-mjkmZBdZgRA/Vo0qu-wacUI/AAAAAAAABIM/QUkDqN3-drU/s400/logo.png' alt="logo" />
        <br/>
            ...
            <table className="table table-striped">
              <thead>
                <tr>
                  ...
                  <th scope="col" className="centerAll">Remove</th>
                </tr>
              </thead>
              <tbody>
  ...
  renderAddEmployee() {
    return(
      <div className="loginForm">
        ...
        <button className="btn btn-dark addEmployeeForm" onClick={()=>{
